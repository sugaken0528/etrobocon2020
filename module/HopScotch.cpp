...
HopScotch::HopScotch(Controller& ctrler_, MoveStraight& linear_, LineTracer& tracer_,
                     Rotation& yaw_)
...
Direction HopScotch::direction2angle(std::vector<int> x_diff, std::vector<int> y_diff,
                                     Direction direct_)  // 北
{
  // よくわかりません
...
//
void HopScotch::cb_cross2MidPoint()
{
  // linear.moveWhileBW();
}

void HopScotch::cb_midPoint2Cross() {}

void HopScotch::cb_yawing() {}

void HopScotch::cb_linear() {}

void HopScotch::cb_mid2Mid() {}